"""
Core building blocks for the visual backbone and audio encoder.
"""
...
class LogSpectrogram(nn.Module):
    ...
    def forward(self, x, tempo_aug=False):
        ...
        for inp_ in x:
            ...
            # apply tempo augmentation if given signal is long enough (at least 10 frames long)
...
class Conv(nn.Module):
    """Standard convolution with normalization and activation."""
...
class Bottleneck(nn.Module):
    """ResNet-style bottleneck block with optional downsampling."""
